  ...
  return (
    <>
      <div className={`size-full fixed ${scene === "cover" ? "-z-50" : ""}`}>
        <CanvasUI scene={scene} setScene={setScene} />
      </div>
        ...
        <>
          ...
          <div className="invisible md:visible fixed w-1/3 flex flex-col bottom-20 xl:bottom-40 right-0 pr-12">
            ...
            <p className="text-2xl">
              This is a test site for a three.js project
            </p>
            <p className="text-md pt-4 text-balance bg-blend-difference">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Optio
              itaque temporibus at voluptates dolor quos possimus consectetur
              quod. Recusandae, quae adipisci ab doloremque nobis ullam aliquid
              voluptatem reiciendis id? Mollitia.
            </p>
          </div>
