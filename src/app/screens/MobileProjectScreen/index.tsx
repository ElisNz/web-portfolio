      ...
      {scene !== "cover" && (
        ...
        >
          <div className="flex flex-col lg:px-lg xl:px-xl">
            ...
            >
              <div
                className={`content-center h-12 w-12 bg-[white]/20 ${
                  scene === "details"
                    ? "absolute right-[4dvw] top-[40vh] opacity-20"
            ...
            >
              <div
                className={`content-center h-16 w-16 bg-[white]/20 ${
                  scene === "details"
                    ? "absolute left-[5dvw] top-[30vh] opacity-40"
            ...
            >
              <div
                className={`z-50 content-center self-center h-40 w-40 bg-[white]/20 ${
          ...
          <div className="p-md lg:p-lg xl:p-xl">
            <h2 className="text-2xl lg:text-3xl xl:text-4xl pb-sm font-semibold [text-shadow:_0_0px_2px_rgb(99_102_241_/_0.4)] dark:[text-shadow:_0_0px_2px_rgb(99_102_241_/_0.8)]">
              {projects.find((i) => i.title === project)?.subtitle}
            </h2>
            <p className="text-[1rem] lg:text-lg xl:text-xl [text-shadow:_0_0px_2px_rgb(99_102_241_/_0.4)] dark:[text-shadow:_0_0px_2px_rgb(99_102_241_/_0.8)]">
