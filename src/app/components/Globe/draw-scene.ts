...
export const drawScene = (gl: WebGLRenderingContext, programInfo: any, buffers: { position: WebGLBuffer | null }) => {
  
  gl.viewport(0, 0, gl.canvas.width, gl.canvas.height); // Set the drawing range of the canvas to the entire canvas
